...
public abstract class AbstractMJdtTreeGenerator extends TreeGenerator {
    ...
    public TreeContext generate(Reader r) throws IOException {
        ...
        AbstractMJdtVisitor v = createVisitor(scanner);
        ...
        if (node.getNodeType() == ASTNode.COMPILATION_UNIT) // if wrong syntax, node will be CompilationUnit
            throw new SyntaxException(this, r);
        node.accept(v);
        return v.getTreeContext();
    }

    protected abstract AbstractMJdtVisitor createVisitor(IScanner scanner);
}
